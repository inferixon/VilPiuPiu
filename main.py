...
sprites.on_overlap(SpriteKind.Blast, SpriteKind.MineHoming, on_on_overlap2)
...
sprites.on_overlap(SpriteKind.PlasmaShot, SpriteKind.MineStatic, on_on_overlap3)

def on_on_overlap4(sprite5, otherSprite4):
    sprites.destroy(sprite5)
    doExplosion(otherSprite4)
    info.player1.change_score_by(2)
sprites.on_overlap(SpriteKind.Weapon1, SpriteKind.MineStatic, on_on_overlap4)
...
sprites.on_overlap(SpriteKind.Weapon2, SpriteKind.MineStatic, on_on_overlap5)

def on_on_overlap6(sprite7, otherSprite6):
    sprites.destroy(sprite7)
    doExplosion(otherSprite6)
    info.player1.change_score_by(5)
sprites.on_overlap(SpriteKind.Weapon1, SpriteKind.MineHoming, on_on_overlap6)
...
sprites.on_overlap(SpriteKind.player, SpriteKind.ContShield, on_on_overlap7)
...
sprites.on_overlap(SpriteKind.Weapon2, SpriteKind.MineHoming, on_on_overlap8)
...
def spawnJet1():
    ...
    controller.player1.move_sprite(jet1, 100, 100)
...
def doShowTips():
    ...
    scene.set_background_image(assets.image("""
        splash-2
    """))
    game.show_long_text("Press GREEN to fire     Press RED to reset game",
        DialogLayout.FULL)

def on_on_overlap9(sprite10, otherSprite9):
    sprites.destroy(sprite10)
    doExplosion(otherSprite9)
sprites.on_overlap(SpriteKind.PlasmaShot, SpriteKind.MineHoming, on_on_overlap9)
...
def on_on_overlap10(sprite11, otherSprite10):
    ...
    if sprite11 == jet1:
        ...
        pause(200)
        sprites.destroy_all_sprites_of_kind(SpriteKind.Shield)
        controller.player1.move_sprite(jet1, 80, 20)
    if sprite11 == jet2:
        ...
        pause(200)
        sprites.destroy_all_sprites_of_kind(SpriteKind.Shield)
        controller.player2.move_sprite(jet2, 80, 20)
sprites.on_overlap(SpriteKind.player, SpriteKind.PlasmaShot, on_on_overlap10)
...
def spawnJet2():
    ...
    controller.player2.move_sprite(jet2, 100, 100)
...
sprites.on_overlap(SpriteKind.Weapon1, SpriteKind.Asteroid, on_on_overlap12)
...
sprites.on_overlap(SpriteKind.Weapon2, SpriteKind.Turrel, on_on_overlap13)

def on_on_overlap14(sprite15, otherSprite14):
    sprites.destroy(sprite15)
    doExplosion(otherSprite14)
sprites.on_overlap(SpriteKind.Blast, SpriteKind.ContWeapon, on_on_overlap14)
...
def on_on_overlap16(sprite17, otherSprite16):
    ...
    if sprite17 == jet2:
        weaponType2 += 1
sprites.on_overlap(SpriteKind.player, SpriteKind.ContWeapon, on_on_overlap16)
...
def on_on_overlap17(sprite19, otherSprite17):
    sprites.destroy(sprite19)
    doExplosion(otherSprite17)
sprites.on_overlap(SpriteKind.Weapon2, SpriteKind.ContShield, on_on_overlap17)
...
def spawnAsteroid(num3: number):
    ...
    """), SpriteKind.Asteroid)
    if num3 == 1:
        animation.run_image_animation(asteroid, assets.animation("""
            aster-1
        """), 444, True)
    if num3 == 2:
        animation.run_image_animation(asteroid, assets.animation("""
...
def on_on_overlap18(sprite20, otherSprite18):
    sprites.destroy(sprite20, effects.fire, 100)
    if Math.percent_chance(50):
        doExplosion(otherSprite18)
        info.player1.change_score_by(7)
sprites.on_overlap(SpriteKind.Weapon1, SpriteKind.Turrel, on_on_overlap18)

def on_on_overlap19(sprite21, otherSprite19):
    sprites.destroy(sprite21)
    doExplosion(otherSprite19)
sprites.on_overlap(SpriteKind.Blast, SpriteKind.ContShield, on_on_overlap19)

def on_on_overlap20(sprite22, otherSprite20):
    sprites.destroy(sprite22)
    doExplosion(otherSprite20)
sprites.on_overlap(SpriteKind.Blast, SpriteKind.MineStatic, on_on_overlap20)

def on_on_overlap21(sprite23, otherSprite21):
    music.play(music.create_sound_effect(WaveShape.NOISE,
            1,
            147,
            99,
    ...
    if sprite23 == jet2:
        ...
        sprites.destroy_all_sprites_of_kind(SpriteKind.Shield)
        controller.player2.move_sprite(jet2, 80, 20)
sprites.on_overlap(SpriteKind.player, SpriteKind.Asteroid, on_on_overlap21)

def on_on_overlap22(sprite24, otherSprite22):
    music.play(music.create_sound_effect(WaveShape.NOISE,
            1,
            147,
            99,
    ...
    if sprite24 == jet2:
        ...
        sprites.destroy_all_sprites_of_kind(SpriteKind.Shield)
        controller.player2.move_sprite(jet2, 80, 20)
sprites.on_overlap(SpriteKind.player, SpriteKind.MineStatic, on_on_overlap22)
...
def on_on_overlap23(sprite25, otherSprite23):
    music.play(music.create_sound_effect(WaveShape.NOISE,
            1,
            147,
            99,
    ...
    if sprite25 == jet2:
        ...
        sprites.destroy_all_sprites_of_kind(SpriteKind.Shield)
        controller.player2.move_sprite(jet2, 80, 20)
sprites.on_overlap(SpriteKind.player, SpriteKind.MineHoming, on_on_overlap23)

def on_on_overlap24(sprite26, otherSprite24):
    sprites.destroy(sprite26)
    doExplosion(otherSprite24)
    info.player2.change_score_by(1)
sprites.on_overlap(SpriteKind.Weapon2, SpriteKind.Asteroid, on_on_overlap24)

def on_on_overlap25(sprite27, otherSprite25):
    sprites.destroy(sprite27)
    doExplosion(otherSprite25)
sprites.on_overlap(SpriteKind.Weapon1, SpriteKind.ContShield, on_on_overlap25)

def on_on_overlap26(sprite28, otherSprite26):
    sprites.destroy(sprite28)
    doExplosion(otherSprite26)
sprites.on_overlap(SpriteKind.Weapon2, SpriteKind.ContWeapon, on_on_overlap26)
...
def on_on_overlap27(sprite29, otherSprite27):
    otherSprite27.y += randint(-15, -25)
    otherSprite27.x += randint(-10, 10)
sprites.on_overlap(SpriteKind.Weapon2, SpriteKind.Blast, on_on_overlap27)

def on_on_overlap28(sprite30, otherSprite28):
    otherSprite28.y += randint(-15, -25)
    otherSprite28.x += randint(-10, 10)
sprites.on_overlap(SpriteKind.Weapon1, SpriteKind.Blast, on_on_overlap28)

def on_on_overlap29(sprite31, otherSprite29):
    sprites.destroy(sprite31)
    doExplosion(otherSprite29)
sprites.on_overlap(SpriteKind.Blast, SpriteKind.Asteroid, on_on_overlap29)
...
def on_on_overlap30(sprite32, otherSprite30):
    music.play(music.create_sound_effect(WaveShape.NOISE,
            1,
            147,
            99,
    ...
    if sprite32 == jet2:
        ...
        sprites.destroy_all_sprites_of_kind(SpriteKind.Shield)
        controller.player2.move_sprite(jet2, 80, 20)
sprites.on_overlap(SpriteKind.player, SpriteKind.Blast, on_on_overlap30)
...
def on_on_overlap31(sprite33, otherSprite31):
...
def on_on_overlap32(sprite34, otherSprite32):
    music.play(music.create_sound_effect(WaveShape.NOISE,
            1,
            147,
            99,
    ...
    if sprite34 == jet1:
        ...
        sprites.destroy_all_sprites_of_kind(SpriteKind.Shield)
        controller.player2.move_sprite(jet2, 80, 20)
sprites.on_overlap(SpriteKind.player, SpriteKind.Turrel, on_on_overlap32)

def on_on_overlap33(sprite35, otherSprite33):
    sprites.destroy(sprite35)
    doExplosion(otherSprite33)
sprites.on_overlap(SpriteKind.PlasmaShot, SpriteKind.Asteroid, on_on_overlap33)

def on_on_overlap34(sprite36, otherSprite34):
    sprites.destroy(sprite36)
    doExplosion(otherSprite34)
sprites.on_overlap(SpriteKind.PlasmaShot, SpriteKind.Turrel, on_on_overlap34)
...
textStart1.set_max_font_height(11)
textStart1.set_outline(1, 6)
textStart1.set_position(80, 57)
effects.confetti.start_screen_effect(500000)
...
def on_update_interval5():
    if gamescreen == 3:
        ...
        if Math.percent_chance(5) and (weaponType1 >= 2 or weaponType2 >= 2):
            spawnMineStatic()
        if Math.percent_chance(5) and (weaponType1 >= 3 or weaponType2 >= 3):
            spawnMineHoming()
